...
export default function () {
        ...
        let res = http.get(`${baseUrl}/catalog-service/api/v2/recommendations?context_identification_id=40&context_identification_type=product&placement=product_page&page=1`, {
            headers: headers
        });
