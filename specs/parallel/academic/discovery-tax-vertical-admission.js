...
export default function () {
        ...
        let res = http.get(`${baseUrl}/discovery-service/api/v1/taxonomies?vertical=admission&group_by=modality`, {
            headers: headers
        });
        ...
        if (res.status !== 200) {
            console.log("discovery-service/api/v1/taxonomies?vertical=admission Status: " + res.status);
        }
