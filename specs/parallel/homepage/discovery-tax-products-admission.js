...
export default function () {
    ...
    let res = http.get(`${baseUrl}/discovery-service/api/v1/taxonomies/products?vertical=admission&product_limit=10&group_by=vertical`, {
        headers: headers
    });
    ...
    // if (res.status !== 200) {
    //     console.log("discovery-service/api/v1/taxonomies/products?vertical=admission Status: " + res.status);
    // }
