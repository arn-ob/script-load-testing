...
export default function () {
        ...
        let res = http.get(`${baseUrl}/skillup-service/api/v4/courses/ghore-boshe-spoken-english/syllabus`, {
            headers: headers
        });
        ...
        if (res.status !== 200) {
            console.log("skillup-service/api/v4/courses/ghore-boshe-spoken-english/syllabus > Status " + res.status);
        }
